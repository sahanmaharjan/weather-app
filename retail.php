...
<html lang="en">
<head>
  <title>Retail Company Detailes | IMS</title>
  <meta charset="utf-8">
...
<?php endif ?>
     ...
     $result =$mysqli->query("select *from retailer") or die($mysqli->error);
   //  pre_r($result);
...
<div class="container">
     ...
     <table class="table table-bordered">
          ...
          while($row=$result->fetch_assoc()):?>
               <tr>
                   ...
                   <td>
                         <a href="retailprocess.php?edit=<?php echo $row['Pan_num']; ?>"
                              class="btn btn-info">Edit</a>
                              <a href="retailprocess.php?delete=<?php echo $row['Pan_num'];?>"
     ...
     endwhile;?>
      ...
      <button onclick="window.location.href='retailerform.php';"> 
     add company
</button>
